...
var (
	...
	CORNER_TOP_LEFT      Synbol = s("╭", "+")
	CORNER_BOTTOM_RIGHT  Synbol = s("╯", "+")
	CORNER_BOTTOM_LEFT   Synbol = s("╰", "+")
	CONNECT_TOP          Synbol = s("┬", "+")
	CONNECT_TOP_LEFT     Synbol = s("┌", "+")
	CONNECT_TOP_RIGHT    Synbol = s("┐", "+")
	CONNECT_BOTTOM       Synbol = s("┴", "+")
	CONNECT_BOTTOM_LEFT  Synbol = s("└", "+")
	CONNECT_BOTTOM_RIGHT Synbol = s("┘", "+")
	CONNECT_LEFT         Synbol = s("├", "+")
	CONNECT_RIGHT        Synbol = s("┤", "+")
	CONNECT_CENTER       Synbol = s("┼", "+")
